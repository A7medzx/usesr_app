        ...
        <tbody>
          <?php while ($user = $all_user->fetch_assoc()) { ?>
            <tr>
              ...
              <td>
                <a href="add_user.php?action=edit&id=<?php echo $user['id']; ?>" class="btn btn-warning">Edit</a>
                <a href="index.php?action=del&id=<?php echo $user['id']; ?>" class="btn btn-danger">Delete</a>
              </td>
            </tr>
          <?php } ?>
        </tbody>
